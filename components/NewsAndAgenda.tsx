        ...
        <div className="grid lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="space-y-10 relative">
              ...
              {[
                ...
                { type: "Mesa Redonda", color: "orange", title: "Ética en IA: Retos 2026", date: "Próximamente", loc: "Centro Cívico Universidad " }
              ].map((act, idx) => (
          ...
          <div>
            ...
            <div className="space-y-8 mb-12">
              ...
              <article className="group cursor-pointer">
                <div className="text-xs font-bold text-slate-400 mb-2 uppercase tracking-widest">24 Feb 2026 • Formación</div>
