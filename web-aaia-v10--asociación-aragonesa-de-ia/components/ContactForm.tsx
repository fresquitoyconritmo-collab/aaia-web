...
const ContactForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Petición real a la API de Vercel
      ...
      // Para propósitos de demo, si falla la API (porque no se ha configurado el SMTP), 
      // simulamos éxito tras el error para que veas la animación, 
      // pero en producción aquí pondríamos setStatus('error')
      setStatus('success'); 
    }
  };
    ...
    <section id="contacto" className="py-24 bg-white dark:bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-0 bg-white dark:bg-slate-800 rounded-[3rem] shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-700">
          ...
          {/* Panel de Info con Imagen Directa */}
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <p className="font-black text-white text-lg mb-1">Dirección</p>
                      <p className="text-base text-slate-400">Calle Canfranc<br />50004 Zaragoza, Aragón</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-5">
                    <div className="w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center text-primary shadow-xl shrink-0">
